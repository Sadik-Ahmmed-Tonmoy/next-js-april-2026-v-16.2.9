...
export default function CreatePost({ darkMode, userAvatar = "/assets/images/txt_img.png" }: CreatePostProps) {
  ...
  return (
    <div className={`${cardBg} rounded-[6px] p-6 mb-4 transition-all duration-200`}>
      {/* Textarea Area */}
      <div className="flex items-start">
        <div className="cursor-pointer mr-3 flex-shrink-0">
          <img src={userAvatar} alt="Image" className="rounded-full object-cover" style={{ maxWidth: "40px", height: "40px", padding: "1px" }} />
        </div>
        <div className="relative w-full">
          <textarea
            className="form-control w-full border-0 p-2 text-sm text-[#212121] placeholder-transparent focus:outline-none focus:ring-0"
          ...
          />
          {/* Custom Floating-like placeholder matching feed.html */}
          {(!text && !isFocused) && (
            <label
              className="absolute left-2 top-2 text-[#767676] pointer-events-none flex items-center gap-1.5 text-base font-normal"
      ...
      {/* For Desktop Bottom Control Panel */}
      <div
        className="hidden md:flex items-center justify-between px-[15px] h-16 rounded-b-[6px] mt-2.5"
        style={{ backgroundColor: "rgba(24, 144, 255, 0.05)" }}
      >
        <div className="flex items-center">
          {/* Photo */}
          <div className="flex items-center px-2.5 cursor-pointer group transition-all duration-200">
            <button type="button" className="border-none bg-transparent flex items-center text-[#767676] hover:text-[#1890FF] text-base transition-all duration-200">
              <span className="mr-2 flex items-center group-hover:text-[#1890FF]">
                <svg className="group-hover:fill-[#1890FF] fill-[#666]" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
          ...
          <div className="flex items-center px-2.5 cursor-pointer group transition-all duration-200">
            <button type="button" className="border-none bg-transparent flex items-center text-[#767676] hover:text-[#1890FF] text-base transition-all duration-200">
              <span className="mr-2 flex items-center group-hover:text-[#1890FF]">
                <svg className="group-hover:fill-[#1890FF] fill-[#666]" xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
          ...
          <div className="flex items-center px-2.5 cursor-pointer group transition-all duration-200">
            <button type="button" className="border-none bg-transparent flex items-center text-[#767676] hover:text-[#1890FF] text-base transition-all duration-200">
              <span className="mr-2 flex items-center group-hover:text-[#1890FF]">
                <svg className="group-hover:fill-[#1890FF] fill-[#666]" xmlns="http://www.w3.org/2000/svg" width="18" height="20" fill="none" viewBox="0 0 18 20">
        ...
        <div className="flex-shrink-0">
          <button
            type="button"
            className="bg-[#1890FF] rounded-[6px] py-3 px-[22px] border border-transparent flex items-center justify-center cursor-pointer transition-all duration-200 hover:bg-[#377DFF] text-white font-medium text-base leading-6"
          >
      ...
      {/* For Mobile Bottom Control Panel */}
      <div className="flex md:hidden items-center justify-between mt-2.5">
        <div className="flex items-center">
          <div className="flex items-center px-1">
            <button type="button" className="border-none bg-transparent p-1.5 flex items-center text-[#767676] hover:text-[#1890FF] transition-all duration-200">
          ...
          <div className="flex items-center px-1">
            <button type="button" className="border-none bg-transparent p-1.5 flex items-center text-[#767676] hover:text-[#1890FF] transition-all duration-200">
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
                <path fill="#666" d="M14.371 2c.32 0 .585.262.627.603l.005.095v.788c2.598.195 4.188 2.033 4.18 5v8.488c0 3.145-1.786 5.026-4.656 5.026H7.395C4.53 22 2.74 20.087 2.74 16.904V8.486c0-2.966 1.596-4.804 4.187-5v-.788c0-.386.283-.698.633-.698zm3.546 8.283H4.004l.001 6.621c0 2.325 1.137 3.616 3.183 3.697l.207.004h7.132c2.184 0 3.39-1.271 3.39-3.63v-6.692zm-3.202 5.853c.349 0 .632.312.632.698 0 .353-.238.645-.546.691l-.086.006c-.357 0-.64-.312-.64-.697 0-.354.237-.645.546-.692l.094-.006zm-3.742 0c.35 0 .632.312.632.698 0 .353-.238.645-.546.691l-.086.006c-.357 0-.64-.312-.64-.697 0-.354.238-.645.546-.692l.094-.006zm-3.75 0c.35 0 .633.312.633.698 0 .353-.238.645-.547.691l-.093.006c-.35 0-.633-.312-.633-.697 0-.354.238-.645.547-.692l.094-.006zm7.492-3.615c.349 0 .632.312.632.697 0 .354-.238.645-.546.692l-.086.006c-.357 0-.64-.312-.64-.698 0-.353.237-.645.546-.691l.094-.006zm-3.742 0c.35 0 .632.312.632.697 0 .354-.238.645-.546.692l-.086.006c-.357 0-.64-.312-.64-.698 0-.353.238-.645.546-.691l.094-.006zm-3.75 0c.35 0 .633.312.633.697 0 .354-.238.645-.547.692l-.093.006c-.35 0-.633-.312-.633-.698 0-.353.238-.645.547-.691l.094-.006zm6.515-7.657H8.192v.895c0 .385-.283.698-.633.698-.32 0-.584-.263-.626-.603l-.006-.095v-.874c-1.886.173-2.922 1.422-2.922 3.6v.402h13.912v-.403c.007-2.181-1.024-3.427-2.914-3.599v.874c0 .385-.283.698-.632.698-.32 0-.585-.263-.627-.603l-.005-.095v-.895z" />
                </svg>
              </button>
            </div>
            <div className="flex items-center px-1">
