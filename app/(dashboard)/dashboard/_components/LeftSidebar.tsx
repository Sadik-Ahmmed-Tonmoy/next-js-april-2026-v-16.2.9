...
export default function LeftSidebar({ darkMode }: LeftSidebarProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className={`${cardBg} p-6 pb-1.5 rounded-[6px] transition-all duration-200`}>
        <h4 className="text-xl font-medium text-[#212121] mb-6 leading-[1.4] m-0">Explore</h4>
        <ul className="list-none p-0 m-0">
          {/* Learning */}
          <li className="relative flex items-center justify-between mb-6">
            <a href="#0" className="flex items-center text-base font-medium text-[#666666] hover:text-[#1890FF] w-full transition-all duration-300">
              <svg className="mr-3.5" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 20 20">
          ...
          <li className="relative flex items-center justify-between mb-6">
            <a href="#0" className="flex items-center text-base font-medium text-[#666666] hover:text-[#1890FF] w-full transition-all duration-300">
              <svg className="mr-3.5" xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
          ...
          {/* Find Friends */}
          <li className="relative flex items-center justify-between mb-6">
            <a href="find-friends.html" className="flex items-center text-base font-medium text-[#666666] hover:text-[#1890FF] w-full transition-all duration-300">
              <svg className="mr-3.5" xmlns="http://www.w3.org/2000/svg" width="22" height="24" fill="none" viewBox="0 0 22 24">
          ...
          {/* Group */}
          <li className="relative flex items-center justify-between mb-6">
            <a href="group.html" className="flex items-center text-base font-medium text-[#666666] hover:text-[#1890FF] w-full transition-all duration-300">
              <svg className="mr-3.5" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <li className="relative flex items-center justify-between mb-6">
            ...
            <span
              className="absolute right-0 text-white flex items-center justify-center font-normal text-xs"
              style={{
                background: "#0ACF83",
          ...
          <li className="relative flex items-center justify-between mb-6">
            <a href="#0" className="flex items-center text-base font-medium text-[#666666] hover:text-[#1890FF] w-full transition-all duration-300">
              <svg className="mr-3.5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          ...
          {/* Save Post */}
          <li className="relative flex items-center justify-between mb-0">
            <a href="#0" className="flex items-center text-base font-medium text-[#666666] hover:text-[#1890FF] w-full transition-all duration-300">
              <svg className="mr-3.5" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 24" fill="none" stroke="#666" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* Block 2: Suggested People */}
      <div className={`${cardBg} p-6 pb-1.5 rounded-[6px] transition-all duration-200`}>
        <div className="flex items-center justify-between mb-6">
          <h4 className="text-xl font-medium text-[#212121] leading-[1.4] m-0">Suggested People</h4>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="mr-4 flex-shrink-0">
                <a href="profile.html">
                  <img src="/assets/images/people1.png" alt="Steve Jobs" className="rounded-full object-cover" style={{ width: "40px", height: "40px" }} />
                </a>
              </div>
              <div>
                <a href="profile.html">
                  <h4 className="font-medium text-sm text-[#212121] leading-[1.4] m-0">Steve Jobs</h4>
                </a>
                <p className="font-light text-[11px] text-[#212121] leading-[1.4] m-0">CEO of Apple</p>
              </div>
            </div>
            <div className="flex-shrink-0">
              <a href="#0" className="font-medium text-xs leading-[1.4] text-[#959EAE] border border-[#DCDFE4] rounded-[2px] p-[7px] block transition-all duration-200 hover:bg-[#1890FF] hover:text-[#F3F9FF] hover:border-[#1890FF]">
                Connect
              </a>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="mr-4 flex-shrink-0">
                <a href="profile.html">
                  <img src="/assets/images/people2.png" alt="Ryan Roslansky" className="rounded-full object-cover" style={{ width: "40px", height: "40px" }} />
                </a>
              </div>
              <div>
                <a href="profile.html">
                  <h4 className="font-medium text-sm text-[#212121] leading-[1.4] m-0">Ryan Roslansky</h4>
                </a>
                <p className="font-light text-[11px] text-[#212121] leading-[1.4] m-0">CEO of Linkedin</p>
              </div>
            </div>
            <div className="flex-shrink-0">
              <a href="#0" className="font-medium text-xs leading-[1.4] text-[#959EAE] border border-[#DCDFE4] rounded-[2px] p-[7px] block transition-all duration-200 hover:bg-[#1890FF] hover:text-[#F3F9FF] hover:border-[#1890FF]">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <div className="mr-4 flex-shrink-0">
                <a href="profile.html">
                  <img src="/assets/images/people3.png" alt="Dylan Field" className="rounded-full object-cover" style={{ width: "40px", height: "40px" }} />
                </a>
              </div>
              <div>
                <a href="profile.html">
                  <h4 className="font-medium text-sm text-[#212121] leading-[1.4] m-0">Dylan Field</h4>
                </a>
                <p className="font-light text-[11px] text-[#212121] leading-[1.4] m-0">CEO of Figma</p>
              </div>
            </div>
            <div className="flex-shrink-0">
              <a href="#0" className="font-medium text-xs leading-[1.4] text-[#959EAE] border border-[#DCDFE4] rounded-[2px] p-[7px] block transition-all duration-200 hover:bg-[#1890FF] hover:text-[#F3F9FF] hover:border-[#1890FF]">
      ...
      <div className={`${cardBg} p-6 pb-1.5 rounded-[6px] transition-all duration-200`}>
        <div className="flex items-center justify-between mb-6">
          <h4 className="text-xl font-medium text-[#212121] leading-[1.2] m-0">Events</h4>
          <a href="event.html" className="text-[#1890FF] font-medium text-xs">See all</a>
        </div>

        {/* Event List */}
        {[1, 2].map((ev) => (
          <a key={ev} className="block mb-4" href="event-single.html">
            <div className="bg-white rounded-[6px]" style={{ boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.08)" }}>
              <div className="rounded-[6px] overflow-hidden">
                <img src="/assets/images/feed_event1.png" alt="Event" className="w-full object-cover rounded-[6px]" />
              </div>
              <div className="p-4 flex items-center">
                <div className="bg-[#0ACF83] rounded-[2px] p-2 text-center flex-shrink-0">
                  <p className="font-bold text-[18px] text-white leading-[1.1] m-0">10</p>
                  <p className="font-normal text-[18px] text-white leading-[1.1] m-0">Jul</p>
                </div>
                <div className="pl-2 pt-1.5">
                  <h4 className="font-medium text-base text-black leading-[1.4] m-0">No more terrorism no more cry</h4>
                </div>
              </div>
              <hr className="bg-[#DFDFDF] border-0 h-[1px] my-1 mx-0" />
              <div className="flex items-center justify-between p-4 pt-0.5 pb-3">
                <p className="font-medium text-xs text-[#8A8A8A] opacity-70 m-0">17 People Going</p>
                <span className="font-medium text-xs text-[#1890FF] bg-[#F3F9FF] border border-[#1890FF] rounded-[2px] px-3.5 py-1 hover:bg-[#1890FF] hover:text-white transition-all duration-200">
                  Going
                </span>
              </div>
            </div>
